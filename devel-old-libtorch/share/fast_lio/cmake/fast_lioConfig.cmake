...
if("TRUE" STREQUAL "TRUE")
  set(fast_lio_SOURCE_PREFIX /home/ruilinli/SimEnv/src/fast_lio)
  set(fast_lio_DEVEL_PREFIX /home/ruilinli/SimEnv/devel)
  set(fast_lio_INSTALL_PREFIX "")
  set(fast_lio_PREFIX ${fast_lio_DEVEL_PREFIX})
else()
  set(fast_lio_SOURCE_PREFIX "")
  set(fast_lio_DEVEL_PREFIX "")
  set(fast_lio_INSTALL_PREFIX /home/ruilinli/SimEnv/install)
...
if(NOT "/home/ruilinli/SimEnv/devel/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(fast_lio_INCLUDE_DIRS "")
  set(_include_dirs "/home/ruilinli/SimEnv/devel/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fast_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruilinli/SimEnv/src/fast_lio/${idir}'.  ${_report}")
    endif()
...
set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;unitree_guide;message_runtime")
