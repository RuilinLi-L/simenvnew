...
// (in-package autonomy_navigation.msg)
...
class DangerCandidate {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DangerCandidate(null);
  ...
  static messageDefinition() {
    ...
    return `
    # A candidate emitted by the perception component.
  ...
  static Resolve(msg) {
    ...
    const resolved = new DangerCandidate(null);
...
module.exports = DangerCandidate;
