...
#ifdef COMPILE_WITH_ROS
    // Foot-kinematics + physical-IMU odometry for localization constraints.
    // This is deliberately published without TF so the localization adapter
    // remains the sole owner of odom -> base.
    ros::NodeHandle _legOdomNh;
    ros::Publisher _legOdomPub;
    nav_msgs::Odometry _legOdomMsg;
    int _legOdomCount = 0;
    double _legOdomPubFreq = 50.0;
#endif
